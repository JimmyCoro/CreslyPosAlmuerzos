...
# STORAGES reemplaza a STATICFILES_STORAGE, que Django 5.1+ ignora: sin esto los
# estáticos salen sin hash en el nombre y WhiteNoise solo los cachea 60 segundos.
STORAGES = {
    'default': {
